...
class MountainBikeGameView(context: Context) : View(context) {
    ...
    private var gestureGuideKey = Long.MIN_VALUE
    private var gestureGuideStartedAt = 0L
    private var snapshot = engine.snapshot()

    private companion object {
        const val GESTURE_VISUAL_AMPLIFICATION = 1.5f
        const val GESTURE_GUIDE_CYCLE_MS = 1_600L
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        drawGestureGuide(canvas, snapshot)
